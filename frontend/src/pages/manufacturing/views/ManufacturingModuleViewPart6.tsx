...
export const ManufacturingModuleViewPart6: React.FC = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [activeFilter, setActiveFilter] = useState('ALL');

  const chartData = [
    { period: 'W1', value: 64500, benchmark: 57000 },
    { period: 'W2', value: 78200, benchmark: 67200 },
    { period: 'W3', value: 74800, benchmark: 70800 },
    { period: 'W4', value: 96900, benchmark: 78700 },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">MANUFACTURING — Enterprise Console (Part 6)</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Active Operations" value="252" change="8.4%" isPositive icon={Layers} color="blue" />
        <StatCard title="Reconciled Volume" value="$11,10,000" change="12.1%" isPositive icon={CheckCircle} color="emerald" />
        <StatCard title="Pending Verifications" value="30" change="Within SLA" isPositive icon={RefreshCw} color="purple" />
        <StatCard title="Variance Index" value="0.06%" change="Optimal" isPositive icon={AlertTriangle} color="amber" />
      </div>
        ...
        <div className="h-64 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData}>
              <defs>
                <linearGradient id="colorVal6" x1="0" y1="0" x2="0" y2="1">
              ...
              <Tooltip />
              <Area type="monotone" dataKey="value" stroke="#2563eb" fillOpacity={1} fill="url(#colorVal6)" strokeWidth={2} name="Actual ($)" />
