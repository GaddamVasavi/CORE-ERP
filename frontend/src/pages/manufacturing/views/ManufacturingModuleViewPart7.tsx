...
export const ManufacturingModuleViewPart7: React.FC = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [activeFilter, setActiveFilter] = useState('ALL');

  const chartData = [
    { period: 'W1', value: 74500, benchmark: 66000 },
    { period: 'W2', value: 90200, benchmark: 77700 },
    { period: 'W3', value: 86300, benchmark: 81800 },
    { period: 'W4', value: 111700, benchmark: 90900 },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">MANUFACTURING — Enterprise Console (Part 7)</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Active Operations" value="294" change="8.4%" isPositive icon={Layers} color="blue" />
        <StatCard title="Reconciled Volume" value="$12,95,000" change="12.1%" isPositive icon={CheckCircle} color="emerald" />
        <StatCard title="Pending Verifications" value="35" change="Within SLA" isPositive icon={RefreshCw} color="purple" />
        <StatCard title="Variance Index" value="0.07%" change="Optimal" isPositive icon={AlertTriangle} color="amber" />
      </div>
        ...
        <div className="h-64 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData}>
              <defs>
                <linearGradient id="colorVal7" x1="0" y1="0" x2="0" y2="1">
              ...
              <Tooltip />
              <Area type="monotone" dataKey="value" stroke="#2563eb" fillOpacity={1} fill="url(#colorVal7)" strokeWidth={2} name="Actual ($)" />
