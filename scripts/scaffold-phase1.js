...
writeFile('backend/src/main/resources/application.yml', `
server:
  port: 8080
  servlet:
    context-path: /
...
spring:
  ...
  datasource:
    url: \${SPRING_DATASOURCE_URL:jdbc:postgresql://localhost:5432/coreerp_db}
    username: \${SPRING_DATASOURCE_USERNAME:coreerp_user}
    password: \${SPRING_DATASOURCE_PASSWORD:coreerp_secure_password_2026}
  ...
  data:
    redis:
      ...
      password: \${SPRING_DATA_REDIS_PASSWORD:coreerp_redis_secret}
      timeout: 3000ms
  ...
  kafka:
    ...
    producer:
      ...
      retries: 3
    consumer:
      group-id: coreerp-group
      auto-offset-reset: earliest
      key-deserializer: org.apache.kafka.common.serialization.StringDeserializer
      value-deserializer: org.springframework.kafka.support.serializer.JsonDeserializer
      properties:
        spring.json.trusted.packages: "com.coreerp.*"

# Security & JWT Configuration
jwt:
  secret: \${JWT_SECRET:c2VjdXJlX2VudGVycHJpc2Vfc2Fhc19qd3Rfc2VjcmV0X2tleV8yMDI2X2NvcmVlcnBfcGxhdGZvcm0=}
  expirationMs: \${JWT_EXPIRATION_MS:86400000} # 24 hours
  refreshExpirationMs: \${JWT_REFRESH_EXPIRATION_MS:604800000} # 7 days
...
writeFile('backend/src/main/resources/application-docker.yml', `
server:
  port: 8080

spring:
  datasource:
    url: jdbc:postgresql://postgres:5432/coreerp_db
    username: coreerp_user
    password: coreerp_secure_password_2026
  data:
    redis:
      host: redis
      port: 6379
      password: coreerp_redis_secret
  kafka:
    bootstrap-servers: kafka:29092
`);

writeFile('backend/src/main/resources/application-test.yml', `
server:
  port: 0
...
// -------------------------------------------------------------
// 2. Flyway V1 Migration SQL
// -------------------------------------------------------------

writeFile('backend/src/main/resources/db/migration/V1__init_enterprise_schema.sql', `
-- ============================================================================
...
console.log("Phase 1 config and Flyway SQL scaffolded successfully.");
