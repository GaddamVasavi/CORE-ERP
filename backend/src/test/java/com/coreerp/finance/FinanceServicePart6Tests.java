...
import com.coreerp.domain.finance.service.FinanceEnterpriseServicePart6;
...
public class FinanceServicePart6Tests {

    private FinanceEnterpriseServicePart6 service;

    @BeforeEach
    void setUp() {
        service = new FinanceEnterpriseServicePart6();
    }

    @Test
    @DisplayName("Verify valid finance operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        FinanceEnterpriseServicePart6.TransactionContext context =
                FinanceEnterpriseServicePart6.TransactionContext.builder()
        ...
        FinanceEnterpriseServicePart6.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        FinanceEnterpriseServicePart6.ValidationResult res =
