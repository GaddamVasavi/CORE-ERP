...
import com.coreerp.domain.finance.service.FinanceEnterpriseServicePart4;
...
public class FinanceServicePart4Tests {

    private FinanceEnterpriseServicePart4 service;

    @BeforeEach
    void setUp() {
        service = new FinanceEnterpriseServicePart4();
    }

    @Test
    @DisplayName("Verify valid finance operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        FinanceEnterpriseServicePart4.TransactionContext context =
                FinanceEnterpriseServicePart4.TransactionContext.builder()
        ...
        FinanceEnterpriseServicePart4.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        FinanceEnterpriseServicePart4.ValidationResult res =
