...
import com.coreerp.domain.finance.service.FinanceEnterpriseServicePart5;
...
public class FinanceServicePart5Tests {

    private FinanceEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new FinanceEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid finance operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        FinanceEnterpriseServicePart5.TransactionContext context =
                FinanceEnterpriseServicePart5.TransactionContext.builder()
        ...
        FinanceEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        FinanceEnterpriseServicePart5.ValidationResult res =
