...
import com.coreerp.domain.finance.service.FinanceEnterpriseServicePart3;
...
public class FinanceServicePart3Tests {

    private FinanceEnterpriseServicePart3 service;

    @BeforeEach
    void setUp() {
        service = new FinanceEnterpriseServicePart3();
    }

    @Test
    @DisplayName("Verify valid finance operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        FinanceEnterpriseServicePart3.TransactionContext context =
                FinanceEnterpriseServicePart3.TransactionContext.builder()
        ...
        FinanceEnterpriseServicePart3.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        FinanceEnterpriseServicePart3.ValidationResult res =
