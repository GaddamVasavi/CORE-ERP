...
import com.coreerp.domain.finance.service.FinanceEnterpriseServicePart8;
...
public class FinanceServicePart8Tests {

    private FinanceEnterpriseServicePart8 service;

    @BeforeEach
    void setUp() {
        service = new FinanceEnterpriseServicePart8();
    }

    @Test
    @DisplayName("Verify valid finance operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        FinanceEnterpriseServicePart8.TransactionContext context =
                FinanceEnterpriseServicePart8.TransactionContext.builder()
        ...
        FinanceEnterpriseServicePart8.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        FinanceEnterpriseServicePart8.ValidationResult res =
