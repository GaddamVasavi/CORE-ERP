...
import com.coreerp.domain.reporting.service.ReportingEnterpriseServicePart1;
...
public class ReportingServicePart1Tests {

    private ReportingEnterpriseServicePart1 service;

    @BeforeEach
    void setUp() {
        service = new ReportingEnterpriseServicePart1();
    }

    @Test
    @DisplayName("Verify valid reporting operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ReportingEnterpriseServicePart1.TransactionContext context =
                ReportingEnterpriseServicePart1.TransactionContext.builder()
        ...
        ReportingEnterpriseServicePart1.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ReportingEnterpriseServicePart1.ValidationResult res =
