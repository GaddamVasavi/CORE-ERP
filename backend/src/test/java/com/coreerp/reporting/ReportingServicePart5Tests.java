...
import com.coreerp.domain.reporting.service.ReportingEnterpriseServicePart5;
...
public class ReportingServicePart5Tests {

    private ReportingEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new ReportingEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid reporting operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ReportingEnterpriseServicePart5.TransactionContext context =
                ReportingEnterpriseServicePart5.TransactionContext.builder()
        ...
        ReportingEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ReportingEnterpriseServicePart5.ValidationResult res =
