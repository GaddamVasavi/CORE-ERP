...
import com.coreerp.domain.reporting.service.ReportingEnterpriseServicePart8;
...
public class ReportingServicePart8Tests {

    private ReportingEnterpriseServicePart8 service;

    @BeforeEach
    void setUp() {
        service = new ReportingEnterpriseServicePart8();
    }

    @Test
    @DisplayName("Verify valid reporting operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ReportingEnterpriseServicePart8.TransactionContext context =
                ReportingEnterpriseServicePart8.TransactionContext.builder()
        ...
        ReportingEnterpriseServicePart8.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ReportingEnterpriseServicePart8.ValidationResult res =
