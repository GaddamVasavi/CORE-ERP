...
import com.coreerp.domain.project.service.ProjectEnterpriseServicePart2;
...
public class ProjectServicePart2Tests {

    private ProjectEnterpriseServicePart2 service;

    @BeforeEach
    void setUp() {
        service = new ProjectEnterpriseServicePart2();
    }

    @Test
    @DisplayName("Verify valid project operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProjectEnterpriseServicePart2.TransactionContext context =
                ProjectEnterpriseServicePart2.TransactionContext.builder()
        ...
        ProjectEnterpriseServicePart2.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProjectEnterpriseServicePart2.ValidationResult res =
