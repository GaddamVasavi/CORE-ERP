...
import com.coreerp.domain.project.service.ProjectEnterpriseServicePart1;
...
public class ProjectServicePart1Tests {

    private ProjectEnterpriseServicePart1 service;

    @BeforeEach
    void setUp() {
        service = new ProjectEnterpriseServicePart1();
    }

    @Test
    @DisplayName("Verify valid project operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProjectEnterpriseServicePart1.TransactionContext context =
                ProjectEnterpriseServicePart1.TransactionContext.builder()
        ...
        ProjectEnterpriseServicePart1.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProjectEnterpriseServicePart1.ValidationResult res =
