...
import com.coreerp.domain.project.service.ProjectEnterpriseServicePart3;
...
public class ProjectServicePart3Tests {

    private ProjectEnterpriseServicePart3 service;

    @BeforeEach
    void setUp() {
        service = new ProjectEnterpriseServicePart3();
    }

    @Test
    @DisplayName("Verify valid project operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProjectEnterpriseServicePart3.TransactionContext context =
                ProjectEnterpriseServicePart3.TransactionContext.builder()
        ...
        ProjectEnterpriseServicePart3.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProjectEnterpriseServicePart3.ValidationResult res =
