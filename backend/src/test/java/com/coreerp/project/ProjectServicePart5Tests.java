...
import com.coreerp.domain.project.service.ProjectEnterpriseServicePart5;
...
public class ProjectServicePart5Tests {

    private ProjectEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new ProjectEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid project operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProjectEnterpriseServicePart5.TransactionContext context =
                ProjectEnterpriseServicePart5.TransactionContext.builder()
        ...
        ProjectEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProjectEnterpriseServicePart5.ValidationResult res =
