...
import com.coreerp.domain.project.service.ProjectEnterpriseServicePart8;
...
public class ProjectServicePart8Tests {

    private ProjectEnterpriseServicePart8 service;

    @BeforeEach
    void setUp() {
        service = new ProjectEnterpriseServicePart8();
    }

    @Test
    @DisplayName("Verify valid project operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProjectEnterpriseServicePart8.TransactionContext context =
                ProjectEnterpriseServicePart8.TransactionContext.builder()
        ...
        ProjectEnterpriseServicePart8.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProjectEnterpriseServicePart8.ValidationResult res =
