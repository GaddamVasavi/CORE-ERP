...
import com.coreerp.domain.project.service.ProjectEnterpriseServicePart6;
...
public class ProjectServicePart6Tests {

    private ProjectEnterpriseServicePart6 service;

    @BeforeEach
    void setUp() {
        service = new ProjectEnterpriseServicePart6();
    }

    @Test
    @DisplayName("Verify valid project operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProjectEnterpriseServicePart6.TransactionContext context =
                ProjectEnterpriseServicePart6.TransactionContext.builder()
        ...
        ProjectEnterpriseServicePart6.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProjectEnterpriseServicePart6.ValidationResult res =
