...
import com.coreerp.domain.hr.service.HrEnterpriseServicePart1;
...
public class HrServicePart1Tests {

    private HrEnterpriseServicePart1 service;

    @BeforeEach
    void setUp() {
        service = new HrEnterpriseServicePart1();
    }

    @Test
    @DisplayName("Verify valid hr operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        HrEnterpriseServicePart1.TransactionContext context =
                HrEnterpriseServicePart1.TransactionContext.builder()
        ...
        HrEnterpriseServicePart1.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        HrEnterpriseServicePart1.ValidationResult res =
