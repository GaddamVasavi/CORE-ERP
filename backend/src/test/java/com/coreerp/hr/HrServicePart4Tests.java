...
import com.coreerp.domain.hr.service.HrEnterpriseServicePart4;
...
public class HrServicePart4Tests {

    private HrEnterpriseServicePart4 service;

    @BeforeEach
    void setUp() {
        service = new HrEnterpriseServicePart4();
    }

    @Test
    @DisplayName("Verify valid hr operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        HrEnterpriseServicePart4.TransactionContext context =
                HrEnterpriseServicePart4.TransactionContext.builder()
        ...
        HrEnterpriseServicePart4.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        HrEnterpriseServicePart4.ValidationResult res =
