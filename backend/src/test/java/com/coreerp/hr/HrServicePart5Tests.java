...
import com.coreerp.domain.hr.service.HrEnterpriseServicePart5;
...
public class HrServicePart5Tests {

    private HrEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new HrEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid hr operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        HrEnterpriseServicePart5.TransactionContext context =
                HrEnterpriseServicePart5.TransactionContext.builder()
        ...
        HrEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        HrEnterpriseServicePart5.ValidationResult res =
