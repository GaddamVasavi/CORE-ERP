...
import com.coreerp.domain.hr.service.HrEnterpriseServicePart6;
...
public class HrServicePart6Tests {

    private HrEnterpriseServicePart6 service;

    @BeforeEach
    void setUp() {
        service = new HrEnterpriseServicePart6();
    }

    @Test
    @DisplayName("Verify valid hr operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        HrEnterpriseServicePart6.TransactionContext context =
                HrEnterpriseServicePart6.TransactionContext.builder()
        ...
        HrEnterpriseServicePart6.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        HrEnterpriseServicePart6.ValidationResult res =
