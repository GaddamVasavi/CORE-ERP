...
import com.coreerp.domain.sales.service.SalesEnterpriseServicePart6;
...
public class SalesServicePart6Tests {

    private SalesEnterpriseServicePart6 service;

    @BeforeEach
    void setUp() {
        service = new SalesEnterpriseServicePart6();
    }

    @Test
    @DisplayName("Verify valid sales operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SalesEnterpriseServicePart6.TransactionContext context =
                SalesEnterpriseServicePart6.TransactionContext.builder()
        ...
        SalesEnterpriseServicePart6.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SalesEnterpriseServicePart6.ValidationResult res =
