...
import com.coreerp.domain.sales.service.SalesEnterpriseServicePart3;
...
public class SalesServicePart3Tests {

    private SalesEnterpriseServicePart3 service;

    @BeforeEach
    void setUp() {
        service = new SalesEnterpriseServicePart3();
    }

    @Test
    @DisplayName("Verify valid sales operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SalesEnterpriseServicePart3.TransactionContext context =
                SalesEnterpriseServicePart3.TransactionContext.builder()
        ...
        SalesEnterpriseServicePart3.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SalesEnterpriseServicePart3.ValidationResult res =
