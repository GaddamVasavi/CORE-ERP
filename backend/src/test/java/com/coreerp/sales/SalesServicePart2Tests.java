...
import com.coreerp.domain.sales.service.SalesEnterpriseServicePart2;
...
public class SalesServicePart2Tests {

    private SalesEnterpriseServicePart2 service;

    @BeforeEach
    void setUp() {
        service = new SalesEnterpriseServicePart2();
    }

    @Test
    @DisplayName("Verify valid sales operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SalesEnterpriseServicePart2.TransactionContext context =
                SalesEnterpriseServicePart2.TransactionContext.builder()
        ...
        SalesEnterpriseServicePart2.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SalesEnterpriseServicePart2.ValidationResult res =
