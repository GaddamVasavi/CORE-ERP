...
import com.coreerp.domain.sales.service.SalesEnterpriseServicePart5;
...
public class SalesServicePart5Tests {

    private SalesEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new SalesEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid sales operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SalesEnterpriseServicePart5.TransactionContext context =
                SalesEnterpriseServicePart5.TransactionContext.builder()
        ...
        SalesEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SalesEnterpriseServicePart5.ValidationResult res =
