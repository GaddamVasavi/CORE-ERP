...
import com.coreerp.domain.inventory.service.InventoryEnterpriseServicePart2;
...
public class InventoryServicePart2Tests {

    private InventoryEnterpriseServicePart2 service;

    @BeforeEach
    void setUp() {
        service = new InventoryEnterpriseServicePart2();
    }

    @Test
    @DisplayName("Verify valid inventory operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        InventoryEnterpriseServicePart2.TransactionContext context =
                InventoryEnterpriseServicePart2.TransactionContext.builder()
        ...
        InventoryEnterpriseServicePart2.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        InventoryEnterpriseServicePart2.ValidationResult res =
