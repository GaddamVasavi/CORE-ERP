...
import com.coreerp.domain.inventory.service.InventoryEnterpriseServicePart5;
...
public class InventoryServicePart5Tests {

    private InventoryEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new InventoryEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid inventory operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        InventoryEnterpriseServicePart5.TransactionContext context =
                InventoryEnterpriseServicePart5.TransactionContext.builder()
        ...
        InventoryEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        InventoryEnterpriseServicePart5.ValidationResult res =
