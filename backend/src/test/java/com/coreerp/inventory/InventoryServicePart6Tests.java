...
import com.coreerp.domain.inventory.service.InventoryEnterpriseServicePart6;
...
public class InventoryServicePart6Tests {

    private InventoryEnterpriseServicePart6 service;

    @BeforeEach
    void setUp() {
        service = new InventoryEnterpriseServicePart6();
    }

    @Test
    @DisplayName("Verify valid inventory operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        InventoryEnterpriseServicePart6.TransactionContext context =
                InventoryEnterpriseServicePart6.TransactionContext.builder()
        ...
        InventoryEnterpriseServicePart6.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        InventoryEnterpriseServicePart6.ValidationResult res =
