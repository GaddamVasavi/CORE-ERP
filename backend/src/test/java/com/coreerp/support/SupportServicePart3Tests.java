...
import com.coreerp.domain.support.service.SupportEnterpriseServicePart3;
...
public class SupportServicePart3Tests {

    private SupportEnterpriseServicePart3 service;

    @BeforeEach
    void setUp() {
        service = new SupportEnterpriseServicePart3();
    }

    @Test
    @DisplayName("Verify valid support operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SupportEnterpriseServicePart3.TransactionContext context =
                SupportEnterpriseServicePart3.TransactionContext.builder()
        ...
        SupportEnterpriseServicePart3.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SupportEnterpriseServicePart3.ValidationResult res =
