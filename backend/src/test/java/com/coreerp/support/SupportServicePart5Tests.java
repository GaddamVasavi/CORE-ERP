...
import com.coreerp.domain.support.service.SupportEnterpriseServicePart5;
...
public class SupportServicePart5Tests {

    private SupportEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new SupportEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid support operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SupportEnterpriseServicePart5.TransactionContext context =
                SupportEnterpriseServicePart5.TransactionContext.builder()
        ...
        SupportEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SupportEnterpriseServicePart5.ValidationResult res =
