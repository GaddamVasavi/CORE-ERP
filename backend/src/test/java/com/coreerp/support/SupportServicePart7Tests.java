...
import com.coreerp.domain.support.service.SupportEnterpriseServicePart7;
...
public class SupportServicePart7Tests {

    private SupportEnterpriseServicePart7 service;

    @BeforeEach
    void setUp() {
        service = new SupportEnterpriseServicePart7();
    }

    @Test
    @DisplayName("Verify valid support operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SupportEnterpriseServicePart7.TransactionContext context =
                SupportEnterpriseServicePart7.TransactionContext.builder()
        ...
        SupportEnterpriseServicePart7.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SupportEnterpriseServicePart7.ValidationResult res =
