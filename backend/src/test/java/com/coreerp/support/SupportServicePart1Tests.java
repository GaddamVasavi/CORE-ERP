...
import com.coreerp.domain.support.service.SupportEnterpriseServicePart1;
...
public class SupportServicePart1Tests {

    private SupportEnterpriseServicePart1 service;

    @BeforeEach
    void setUp() {
        service = new SupportEnterpriseServicePart1();
    }

    @Test
    @DisplayName("Verify valid support operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        SupportEnterpriseServicePart1.TransactionContext context =
                SupportEnterpriseServicePart1.TransactionContext.builder()
        ...
        SupportEnterpriseServicePart1.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        SupportEnterpriseServicePart1.ValidationResult res =
