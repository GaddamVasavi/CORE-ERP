...
import com.coreerp.domain.procurement.service.ProcurementEnterpriseServicePart7;
...
public class ProcurementServicePart7Tests {

    private ProcurementEnterpriseServicePart7 service;

    @BeforeEach
    void setUp() {
        service = new ProcurementEnterpriseServicePart7();
    }

    @Test
    @DisplayName("Verify valid procurement operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProcurementEnterpriseServicePart7.TransactionContext context =
                ProcurementEnterpriseServicePart7.TransactionContext.builder()
        ...
        ProcurementEnterpriseServicePart7.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProcurementEnterpriseServicePart7.ValidationResult res =
