...
import com.coreerp.domain.procurement.service.ProcurementEnterpriseServicePart4;
...
public class ProcurementServicePart4Tests {

    private ProcurementEnterpriseServicePart4 service;

    @BeforeEach
    void setUp() {
        service = new ProcurementEnterpriseServicePart4();
    }

    @Test
    @DisplayName("Verify valid procurement operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProcurementEnterpriseServicePart4.TransactionContext context =
                ProcurementEnterpriseServicePart4.TransactionContext.builder()
        ...
        ProcurementEnterpriseServicePart4.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProcurementEnterpriseServicePart4.ValidationResult res =
