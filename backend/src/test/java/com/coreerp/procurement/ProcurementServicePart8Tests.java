...
import com.coreerp.domain.procurement.service.ProcurementEnterpriseServicePart8;
...
public class ProcurementServicePart8Tests {

    private ProcurementEnterpriseServicePart8 service;

    @BeforeEach
    void setUp() {
        service = new ProcurementEnterpriseServicePart8();
    }

    @Test
    @DisplayName("Verify valid procurement operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ProcurementEnterpriseServicePart8.TransactionContext context =
                ProcurementEnterpriseServicePart8.TransactionContext.builder()
        ...
        ProcurementEnterpriseServicePart8.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ProcurementEnterpriseServicePart8.ValidationResult res =
