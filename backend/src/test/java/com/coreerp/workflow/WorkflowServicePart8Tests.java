...
import com.coreerp.domain.workflow.service.WorkflowEnterpriseServicePart8;
...
public class WorkflowServicePart8Tests {

    private WorkflowEnterpriseServicePart8 service;

    @BeforeEach
    void setUp() {
        service = new WorkflowEnterpriseServicePart8();
    }

    @Test
    @DisplayName("Verify valid workflow operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        WorkflowEnterpriseServicePart8.TransactionContext context =
                WorkflowEnterpriseServicePart8.TransactionContext.builder()
        ...
        WorkflowEnterpriseServicePart8.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        WorkflowEnterpriseServicePart8.ValidationResult res =
