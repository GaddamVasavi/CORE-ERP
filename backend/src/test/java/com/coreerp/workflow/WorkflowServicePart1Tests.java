...
import com.coreerp.domain.workflow.service.WorkflowEnterpriseServicePart1;
...
public class WorkflowServicePart1Tests {

    private WorkflowEnterpriseServicePart1 service;

    @BeforeEach
    void setUp() {
        service = new WorkflowEnterpriseServicePart1();
    }

    @Test
    @DisplayName("Verify valid workflow operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        WorkflowEnterpriseServicePart1.TransactionContext context =
                WorkflowEnterpriseServicePart1.TransactionContext.builder()
        ...
        WorkflowEnterpriseServicePart1.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        WorkflowEnterpriseServicePart1.ValidationResult res =
