...
import com.coreerp.domain.workflow.service.WorkflowEnterpriseServicePart2;
...
public class WorkflowServicePart2Tests {

    private WorkflowEnterpriseServicePart2 service;

    @BeforeEach
    void setUp() {
        service = new WorkflowEnterpriseServicePart2();
    }

    @Test
    @DisplayName("Verify valid workflow operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        WorkflowEnterpriseServicePart2.TransactionContext context =
                WorkflowEnterpriseServicePart2.TransactionContext.builder()
        ...
        WorkflowEnterpriseServicePart2.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        WorkflowEnterpriseServicePart2.ValidationResult res =
