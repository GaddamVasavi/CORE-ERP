...
import com.coreerp.domain.workflow.service.WorkflowEnterpriseServicePart4;
...
public class WorkflowServicePart4Tests {

    private WorkflowEnterpriseServicePart4 service;

    @BeforeEach
    void setUp() {
        service = new WorkflowEnterpriseServicePart4();
    }

    @Test
    @DisplayName("Verify valid workflow operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        WorkflowEnterpriseServicePart4.TransactionContext context =
                WorkflowEnterpriseServicePart4.TransactionContext.builder()
        ...
        WorkflowEnterpriseServicePart4.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        WorkflowEnterpriseServicePart4.ValidationResult res =
