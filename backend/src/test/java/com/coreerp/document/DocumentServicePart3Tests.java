...
import com.coreerp.domain.document.service.DocumentEnterpriseServicePart3;
...
public class DocumentServicePart3Tests {

    private DocumentEnterpriseServicePart3 service;

    @BeforeEach
    void setUp() {
        service = new DocumentEnterpriseServicePart3();
    }

    @Test
    @DisplayName("Verify valid document operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        DocumentEnterpriseServicePart3.TransactionContext context =
                DocumentEnterpriseServicePart3.TransactionContext.builder()
        ...
        DocumentEnterpriseServicePart3.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        DocumentEnterpriseServicePart3.ValidationResult res =
