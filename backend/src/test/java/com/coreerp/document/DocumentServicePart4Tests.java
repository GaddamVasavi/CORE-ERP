...
import com.coreerp.domain.document.service.DocumentEnterpriseServicePart4;
...
public class DocumentServicePart4Tests {

    private DocumentEnterpriseServicePart4 service;

    @BeforeEach
    void setUp() {
        service = new DocumentEnterpriseServicePart4();
    }

    @Test
    @DisplayName("Verify valid document operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        DocumentEnterpriseServicePart4.TransactionContext context =
                DocumentEnterpriseServicePart4.TransactionContext.builder()
        ...
        DocumentEnterpriseServicePart4.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        DocumentEnterpriseServicePart4.ValidationResult res =
