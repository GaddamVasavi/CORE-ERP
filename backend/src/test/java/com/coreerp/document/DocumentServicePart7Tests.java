...
import com.coreerp.domain.document.service.DocumentEnterpriseServicePart7;
...
public class DocumentServicePart7Tests {

    private DocumentEnterpriseServicePart7 service;

    @BeforeEach
    void setUp() {
        service = new DocumentEnterpriseServicePart7();
    }

    @Test
    @DisplayName("Verify valid document operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        DocumentEnterpriseServicePart7.TransactionContext context =
                DocumentEnterpriseServicePart7.TransactionContext.builder()
        ...
        DocumentEnterpriseServicePart7.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        DocumentEnterpriseServicePart7.ValidationResult res =
