...
import com.coreerp.domain.document.service.DocumentEnterpriseServicePart6;
...
public class DocumentServicePart6Tests {

    private DocumentEnterpriseServicePart6 service;

    @BeforeEach
    void setUp() {
        service = new DocumentEnterpriseServicePart6();
    }

    @Test
    @DisplayName("Verify valid document operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        DocumentEnterpriseServicePart6.TransactionContext context =
                DocumentEnterpriseServicePart6.TransactionContext.builder()
        ...
        DocumentEnterpriseServicePart6.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        DocumentEnterpriseServicePart6.ValidationResult res =
