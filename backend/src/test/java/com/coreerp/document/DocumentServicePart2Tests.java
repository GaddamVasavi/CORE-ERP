...
import com.coreerp.domain.document.service.DocumentEnterpriseServicePart2;
...
public class DocumentServicePart2Tests {

    private DocumentEnterpriseServicePart2 service;

    @BeforeEach
    void setUp() {
        service = new DocumentEnterpriseServicePart2();
    }

    @Test
    @DisplayName("Verify valid document operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        DocumentEnterpriseServicePart2.TransactionContext context =
                DocumentEnterpriseServicePart2.TransactionContext.builder()
        ...
        DocumentEnterpriseServicePart2.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        DocumentEnterpriseServicePart2.ValidationResult res =
