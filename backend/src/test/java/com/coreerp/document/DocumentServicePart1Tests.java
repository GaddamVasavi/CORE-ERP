...
import com.coreerp.domain.document.service.DocumentEnterpriseServicePart1;
...
public class DocumentServicePart1Tests {

    private DocumentEnterpriseServicePart1 service;

    @BeforeEach
    void setUp() {
        service = new DocumentEnterpriseServicePart1();
    }

    @Test
    @DisplayName("Verify valid document operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        DocumentEnterpriseServicePart1.TransactionContext context =
                DocumentEnterpriseServicePart1.TransactionContext.builder()
        ...
        DocumentEnterpriseServicePart1.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        DocumentEnterpriseServicePart1.ValidationResult res =
