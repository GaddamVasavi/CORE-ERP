...
import com.coreerp.domain.asset.service.AssetEnterpriseServicePart8;
...
public class AssetServicePart8Tests {

    private AssetEnterpriseServicePart8 service;

    @BeforeEach
    void setUp() {
        service = new AssetEnterpriseServicePart8();
    }

    @Test
    @DisplayName("Verify valid asset operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        AssetEnterpriseServicePart8.TransactionContext context =
                AssetEnterpriseServicePart8.TransactionContext.builder()
        ...
        AssetEnterpriseServicePart8.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        AssetEnterpriseServicePart8.ValidationResult res =
