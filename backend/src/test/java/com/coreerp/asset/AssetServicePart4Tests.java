...
import com.coreerp.domain.asset.service.AssetEnterpriseServicePart4;
...
public class AssetServicePart4Tests {

    private AssetEnterpriseServicePart4 service;

    @BeforeEach
    void setUp() {
        service = new AssetEnterpriseServicePart4();
    }

    @Test
    @DisplayName("Verify valid asset operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        AssetEnterpriseServicePart4.TransactionContext context =
                AssetEnterpriseServicePart4.TransactionContext.builder()
        ...
        AssetEnterpriseServicePart4.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        AssetEnterpriseServicePart4.ValidationResult res =
