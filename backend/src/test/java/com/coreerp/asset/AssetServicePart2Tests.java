...
import com.coreerp.domain.asset.service.AssetEnterpriseServicePart2;
...
public class AssetServicePart2Tests {

    private AssetEnterpriseServicePart2 service;

    @BeforeEach
    void setUp() {
        service = new AssetEnterpriseServicePart2();
    }

    @Test
    @DisplayName("Verify valid asset operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        AssetEnterpriseServicePart2.TransactionContext context =
                AssetEnterpriseServicePart2.TransactionContext.builder()
        ...
        AssetEnterpriseServicePart2.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        AssetEnterpriseServicePart2.ValidationResult res =
