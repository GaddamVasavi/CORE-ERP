...
import com.coreerp.domain.analytics.service.AnalyticsEnterpriseServicePart1;
...
public class AnalyticsServicePart1Tests {

    private AnalyticsEnterpriseServicePart1 service;

    @BeforeEach
    void setUp() {
        service = new AnalyticsEnterpriseServicePart1();
    }

    @Test
    @DisplayName("Verify valid analytics operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        AnalyticsEnterpriseServicePart1.TransactionContext context =
                AnalyticsEnterpriseServicePart1.TransactionContext.builder()
        ...
        AnalyticsEnterpriseServicePart1.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        AnalyticsEnterpriseServicePart1.ValidationResult res =
