...
import com.coreerp.domain.manufacturing.service.ManufacturingEnterpriseServicePart8;
...
public class ManufacturingServicePart8Tests {

    private ManufacturingEnterpriseServicePart8 service;

    @BeforeEach
    void setUp() {
        service = new ManufacturingEnterpriseServicePart8();
    }

    @Test
    @DisplayName("Verify valid manufacturing operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ManufacturingEnterpriseServicePart8.TransactionContext context =
                ManufacturingEnterpriseServicePart8.TransactionContext.builder()
        ...
        ManufacturingEnterpriseServicePart8.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ManufacturingEnterpriseServicePart8.ValidationResult res =
