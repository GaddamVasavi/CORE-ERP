...
import com.coreerp.domain.manufacturing.service.ManufacturingEnterpriseServicePart5;
...
public class ManufacturingServicePart5Tests {

    private ManufacturingEnterpriseServicePart5 service;

    @BeforeEach
    void setUp() {
        service = new ManufacturingEnterpriseServicePart5();
    }

    @Test
    @DisplayName("Verify valid manufacturing operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ManufacturingEnterpriseServicePart5.TransactionContext context =
                ManufacturingEnterpriseServicePart5.TransactionContext.builder()
        ...
        ManufacturingEnterpriseServicePart5.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ManufacturingEnterpriseServicePart5.ValidationResult res =
