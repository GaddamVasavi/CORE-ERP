...
import com.coreerp.domain.manufacturing.service.ManufacturingEnterpriseServicePart2;
...
public class ManufacturingServicePart2Tests {

    private ManufacturingEnterpriseServicePart2 service;

    @BeforeEach
    void setUp() {
        service = new ManufacturingEnterpriseServicePart2();
    }

    @Test
    @DisplayName("Verify valid manufacturing operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ManufacturingEnterpriseServicePart2.TransactionContext context =
                ManufacturingEnterpriseServicePart2.TransactionContext.builder()
        ...
        ManufacturingEnterpriseServicePart2.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ManufacturingEnterpriseServicePart2.ValidationResult res =
