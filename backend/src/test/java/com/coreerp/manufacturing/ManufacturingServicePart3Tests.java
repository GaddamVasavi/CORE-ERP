...
import com.coreerp.domain.manufacturing.service.ManufacturingEnterpriseServicePart3;
...
public class ManufacturingServicePart3Tests {

    private ManufacturingEnterpriseServicePart3 service;

    @BeforeEach
    void setUp() {
        service = new ManufacturingEnterpriseServicePart3();
    }

    @Test
    @DisplayName("Verify valid manufacturing operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ManufacturingEnterpriseServicePart3.TransactionContext context =
                ManufacturingEnterpriseServicePart3.TransactionContext.builder()
        ...
        ManufacturingEnterpriseServicePart3.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ManufacturingEnterpriseServicePart3.ValidationResult res =
