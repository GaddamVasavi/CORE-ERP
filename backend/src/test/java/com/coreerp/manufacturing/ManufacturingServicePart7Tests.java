...
import com.coreerp.domain.manufacturing.service.ManufacturingEnterpriseServicePart7;
...
public class ManufacturingServicePart7Tests {

    private ManufacturingEnterpriseServicePart7 service;

    @BeforeEach
    void setUp() {
        service = new ManufacturingEnterpriseServicePart7();
    }

    @Test
    @DisplayName("Verify valid manufacturing operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ManufacturingEnterpriseServicePart7.TransactionContext context =
                ManufacturingEnterpriseServicePart7.TransactionContext.builder()
        ...
        ManufacturingEnterpriseServicePart7.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ManufacturingEnterpriseServicePart7.ValidationResult res =
