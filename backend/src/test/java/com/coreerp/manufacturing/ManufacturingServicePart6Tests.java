...
import com.coreerp.domain.manufacturing.service.ManufacturingEnterpriseServicePart6;
...
public class ManufacturingServicePart6Tests {

    private ManufacturingEnterpriseServicePart6 service;

    @BeforeEach
    void setUp() {
        service = new ManufacturingEnterpriseServicePart6();
    }

    @Test
    @DisplayName("Verify valid manufacturing operation execution and checksum integrity")
    void testSuccessfulOperationExecution() {
        ManufacturingEnterpriseServicePart6.TransactionContext context =
                ManufacturingEnterpriseServicePart6.TransactionContext.builder()
        ...
        ManufacturingEnterpriseServicePart6.ExecutionSummary summary =
    ...
    void testValidationNegativeAmount() {
        ...
        ManufacturingEnterpriseServicePart6.ValidationResult res =
